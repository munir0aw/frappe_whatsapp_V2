(() => {
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_bubble.js
  var ChatBubble = class {
    ...
    setup() {
      ...
      this.open_title = this.parent.is_admin ? __("Show Chats") : __("Chat With Us");
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_utils.js
  var import_moment = __toESM(require_moment());
  function get_time(time) {
    let current_time;
    if (time) {
      current_time = (0, import_moment.default)(time);
    } else {
      current_time = (0, import_moment.default)();
    }
  ...
  function get_date_from_now(dateObj, type) {
    ...
    const result = (0, import_moment.default)(dateObj).calendar(null, {
      sameDay,
      lastDay: "[Yesterday]",
      lastWeek: elseDay,
      sameElse: elseDay
  ...
  function is_date_change(dateObj, prevObj) {
    const curDate = (0, import_moment.default)(dateObj).format("DD/MM/YYYY");
    const prevDate = (0, import_moment.default)(prevObj).format("DD/MM/YYYY");
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_space.js
  var ChatSpace = class {
    constructor(opts) {
    ...
    setup_header() {
      ...
      const header_html = `
			<div class='chat-header'>
				${this.profile.is_admin === true ? `<span class='chat-back-button' title='${__("Go Back")}' >
    ...
    setup_socketio() {
      const me = this;
      this.received_message_ids = /* @__PURE__ */ new Set();
    ...
    get_typing_changes(res) {
      if (res.user != this.profile.user_email) {
        if (this.profile.is_admin === true && res.is_guest === "true" || this.profile.is_admin === false || this.profile.room_type === "Group" || this.profile.room_type === "Direct") {
    ...
    make_message(content, time, type, name, caption) {
      ...
      const $name_element = $(document.createElement("div")).addClass("message-name").text(name);
      ...
      if (caption) {
        const $caption_element = $(document.createElement("div")).addClass("message-caption").css({
    ...
    handle_send_message(attachment) {
      ...
      if (this.profile.is_admin === true && frappe.Chat.settings.user.enable_message_tone === 1) {
    ...
    receive_message(res, time) {
      ...
      if (this.profile.is_admin === true && $(".chat-element").is(":visible") && frappe.Chat.settings.user.enable_message_tone === 1) {
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_room.js
  var ChatRoom = class {
    constructor(opts) {
      this.$wrapper = opts.$wrapper;
    ...
    setup() {
      ...
      const info_html = `
			<div class='chat-profile-info'>
				...
				<div style='color: ${this.profile.is_read ? "var(--text-muted)" : "var(--text-color)"}' class='last-message'>${__(last_message)}</div>
			</div>
		`;
      const date_html = `
			<div class='chat-date'>
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_add_room.js
  var ChatAddRoom = class {
    constructor(opts) {
      this.user = opts.user;
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_user_settings.js
  var ChatUserSettings = class {
    constructor() {
      this.setup();
    }
    async setup() {
        ...
        action: {
          primary: {
            ...
            onsubmit: (values) => {
              ...
              frappe.Chat.settings.user.enable_message_tone = values.enable_message_tone;
              frappe.Chat.settings.user.enable_notifications = values.enable_notifications;
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_list.js
  var ChatList = class {
    constructor(opts) {
      this.$wrapper = opts.$wrapper;
      this.user = opts.user;
    ...
    setup_socketio() {
      ...
      frappe.realtime.on("latest_chat_updates", function(res) {
        ...
        frappe.utils.play_sound("chat-message-receive");
        const message = res.content.length > 24 ? res.content.substring(0, 24) + "..." : res.content;
        frappe.show_alert({
      ...
      frappe.realtime.on("private_room_creation", function(res) {
        if (!$(".chat-element").is(":visible") && frappe.Chat.settings.user.enable_notifications === 1) {
          frappe.utils.play_sound("chat-notification");
        }
        if (res.members.includes(me.user_email)) {
          if (res.room_type === "Direct") {
            res.room_name = res.member_names[0]["email"] == me.user_email ? res.member_names[1]["name"] : res.member_names[0]["name"];
            res.opposite_person_email = res.member_names[0]["email"] == me.user_email ? res.member_names[1]["email"] : res.member_names[0]["email"];
          }
          res.user = me.user;
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_form.js
  var ChatForm = class {
    constructor(opts) {
      this.$wrapper = opts.$wrapper;
      this.profile = opts.profile;
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/components/chat_welcome_screen.js
  var ChatWelcome = class {
    constructor(opts) {
      this.$wrapper = opts.$wrapper;
      this.profile = opts.profile;
      this.setup();
    ...
    setup() {
      ...
      const welcome_html = `
		...
		`;
      const status_text = this.profile.chat_status === "Online" ? __("We are online") : __("We are offline");
      const reason_text = this.profile.chat_status === "Online" ? __("Typically replies in a few hours") : __("Just drop a message and we will get back to you soon");
      const bottom_html = `
  ...
  // ../../../../../mnt/d/frappe_whatsapp_V2/frappe_whatsapp/public/js/frappe_whatsapp.bundle.js
...
//! momentjs.com
//! version : 2.29.4
//# sourceMappingURL=frappe_whatsapp.bundle.TFR7BVCH.js.map
