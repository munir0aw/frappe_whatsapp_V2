frappe.pages['whatsapp_chat'].on_page_load = function(wrapper) {
	...
	fetch('/assets/frappe_whatsapp/frontend/.vite/manifest.json')
		...
		.catch(err => {
			...
			import('/assets/frappe_whatsapp/frontend/assets/index-C4idt67S.js')
				.then(() => {
					$('<link rel="stylesheet" href="/assets/frappe_whatsapp/frontend/assets/index-Ch0gLfoK.css">').appendTo('head');
